...
draw_text(camera_get_view_x(view_camera[0]) + camera_get_view_width(view_camera[0]) - 145, camera_get_view_y(view_camera[0]) + camera_get_view_height(view_camera[0]) - 50, mes + string(count));
//